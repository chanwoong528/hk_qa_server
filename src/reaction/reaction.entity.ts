...
export class Reaction {
  ...
  @Column({ default: E_ReactionParentType.testUnit, type: 'enum', enum: E_ReactionParentType })
  parentType: E_ReactionParentType;

  @Column({ default: E_ReactionType.check, type: 'enum', enum: E_ReactionType })
  ...
  @ManyToOne((type) => Comment, (comment) => comment, { nullable: true, eager: true, cascade: true, })
  parentComment?: Comment;

  @ManyToOne((type) => TestUnit, (testUnit) => testUnit, { nullable: true, eager: true, cascade: true, onDelete: "CASCADE" })
